      ...
      function(e, t, n) {
        !(function(e, n) {
          ...
          function b(e, t, n, r, o) {
            for (
              var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], h = 0, d = e.length;
              h < d;
              h++
            )
              if (((i = e[h]), i || 0 === i))
          ...
          function _(e, t, n) {
            for (
              var r, o = (U.tweeners[t] || []).concat(U.tweeners['*']), i = 0, a = o.length;
              i < a;
              i++
            )
            ...
            if (((u = !de.isEmptyObject(t)), u || !de.isEmptyObject(h))) {
              f &&
                ...
                'none' === c &&
                  (l
                    ? (c = l)
                    : (m([e], !0), (l = e.style.display || l), (c = de.css(e, 'display')), m([e]))),
              ...
              if ((r = U.prefilters[i].call(l, e, c, l.opts)))
                return (
                  de.isFunction(r.stop) &&
                    (de._queueHooks(l.elem, l.opts.queue).stop = de.proxy(r.stop, r)),
                  r
                );
            return (
              de.map(c, _, l),
              ...
              for (
                var t,
                  ...
                  c = [
                    function(e, n, r) {
                      var o =
                        (!i && (r || n !== A)) || ((t = n).nodeType ? u(e, n, r) : l(e, n, r));
                      return (t = null), o;
                    },
                  ];
                s < o;
              ...
              if (!Ce.test(e))
                for (; r < o; r++)
                  for (n = this[r]; n && n !== t; n = n.parentNode)
                    if (
                      n.nodeType < 11 &&
                      (a ? a.index(n) > -1 : 1 === n.nodeType && de.find.matchesSelector(n, e))
                    ) {
                      i.push(n);
                      break;
                    }
            ...
            var t,
              ...
              c = {
                ...
                fireWith: function(e, n) {
                  return (
                    o || ((n = n || []), (n = [e, n.slice ? n.slice() : n]), s.push(n), t || l()),
                    this
                  );
                },
                fire: function() {
                              ...
                              : function() {
                                  try {
                                    ...
                                    de.Deferred.exceptionHook &&
                                      ...
                                      t + 1 >= a &&
                                        (r !== u && ((l = void 0), (c = [e])), n.rejectWith(l, c));
                                  }
                                };
                          t
                            ? p()
            ...
            de.fn.extend({
              data: function(e, t) {
                ...
                if (void 0 === e) {
                  if (
                    this.length &&
                    ((o = Pe.get(i)), 1 === i.nodeType && !Fe.get(i, 'hasDataAttrs'))
                  ) {
                    for (n = a.length; n--; )
                      a[n] &&
                        ((r = a[n].name),
          ...
          (de.event = {
            ...
            dispatch: function(e) {
              ...
              if (
                ((s.delegateTarget = this), !c.preDispatch || c.preDispatch.call(this, s) !== !1)
              ) {
                for (
            ...
            de.each(de.expr.match.bool.source.match(/\w+/g), function(e, t) {
              ...
              yt[t] = function(e, t, r) {
                var o,
                  ...
                  a = t.toLowerCase();
                return (
                  r || ((i = yt[a]), (yt[a] = o), (o = null != n(e, t, r) ? a : null), (yt[a] = i)),
                  o
                );
              };
            });
            ...
            de.extend({
              ...
              ajax: function(t, n) {
                ...
                (f = de.event && d.global),
                  ...
                  d.ifModified &&
                    (de.lastModified[i] &&
                      T.setRequestHeader('If-Modified-Since', de.lastModified[i]),
        ...
        (r.prototype.parse = function(e, t, n) {
          ...
          if (!C[h] && (j || (h && !T[h]))) {
            ...
            (q = E === -1 ? s.lastIndexOf('@') : s.lastIndexOf('@', E)),
              q !== -1 &&
                ((A = s.slice(0, q)), (s = s.slice(q + 1)), (this.auth = decodeURIComponent(A))),
              (E = -1);
