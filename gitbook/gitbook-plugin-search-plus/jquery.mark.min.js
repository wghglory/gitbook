                    ...
                    var j = (function() {
                      ...
                      return (
                        ...
                        a.nodes.forEach(function(b, c) {
                          c >= h &&
                            (a.nodes[c].start > 0 && c !== h && (a.nodes[c].start -= j),
                            (a.nodes[c].end -= j));
                        }),
                        (c -= j),
                    ...
                    (a =
                      'undefined' != typeof this.ctx && this.ctx
                        ? NodeList.prototype.isPrototypeOf(this.ctx)
                          ...
                          ? Array.prototype.slice.call(b.querySelectorAll(this.ctx))
                          : [this.ctx]
                        : []),
                    a.forEach(function(a) {
                      var b =
                  ...
                  var d = this,
                    ...
                    g = function g() {
                      if (!e) {
                        ...
                        try {
                          d.isIframeBlank(a) ||
                            (a.removeEventListener('load', g), d.getIframeContents(a, b, c));
                        } catch (a) {
                          c();
                        }
                      }
              ...
              },
              {
                ...
                value: function(a) {
                  var b = a.previousNode(),
                    c = void 0;
                  return (
                    (c = null === b ? a.nextNode() : a.nextNode() && a.nextNode()),
                    { prevNode: b, node: c }
                  );
                },
              },
